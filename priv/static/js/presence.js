...
var _user$project$Presence$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'PhoenixMsg':
				var a = A2(_elm_lang$core$Debug$log, 'phoenixmsg', _p0._0);
...
var _user$project$Presence$PhoenixMsg = function (a) {
	...
	function (model, msg) {
		...
		return {
			...
			_0: _elm_lang$core$Native_Utils.update(
				model,
				{socket: phxSocket}),
			_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Presence$PhoenixMsg, phxCmd)
		};
	});
var _user$project$Presence$subscriptions = function (model) {
...
var _user$project$Presence$main = _elm_lang$core$Platform$program(
	{init: _user$project$Presence$init, subscriptions: _user$project$Presence$subscriptions, update: _user$project$Presence$update})();

var Elm = {};
Elm['Presence'] = Elm['Presence'] || {};
if (typeof _user$project$Presence$main !== 'undefined') {
    _user$project$Presence$main(Elm['Presence'], 'Presence', undefined);
}
